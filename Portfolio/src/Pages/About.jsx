  ...
  return (
    <div className='father card flex-col m-auto w-[60%] h-[30vw] text-white'>
      ...
      <div className='about-text text-center flex-col content-center m-auto p-[10%] lg:p-[10px] xl:p-[20px]'>
        <h1 className='mb-[2%] sm:text-[50px] md:text-[85px] lg:text-[45px] xl:text-[55px]'>
          About me
        </h1>
        <p className=' mb-[5%] sm:text-[20px] md:text-[25px] lg:text-[18px] lg:mb-[15%] xl:text-[24px] xxl:text-[33px]'>
