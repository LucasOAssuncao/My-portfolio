    ...
    return (
      <div className='father card flex-col m-auto w-[60%] h-[30vw] text-white'>
        ...
        <div className='about-text text-center flex-col content-center m-auto sm:'>
          <h1 className='mb-[3%] sm:text-[40px] sm:pt-[15vh] md:pt-[20%] md:text-[65px] xl:text-[45px] lg:text-[35px] lg:pt-[0] xxl:text-[55px]'>You can find me on</h1>
          ...
          <p className='sm:text-[40px] md:text-[65px] lg:text-[35px] xl:text-[45px] xxl:text-[55px]'>
            Or you can send me an email <br />
          </p>
          <p className='sm:text-[25px] sm:mt-[10px] md:text-[55px] lg:text-[35px] xl:text-[42px] xxl:text-[50px]'>lucasotoni.dev@gmail.com</p>
          </div>
        </div>
      </div>
    );
